...
import { setProductReview, setReviewCount } from '../redux/reducers/productSlice';
...
export default function ProductDetails() {
  ...
  const handleAddReview = (review, productId) => {
    dispatch(setProductReview({ productId, review }));
    dispatch(setReviewCount(productId));
  };
        ...
        <div key={product.id}>
          ...
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              ...
              const review = values.comment + ': ' + values.rating;
              handleAddReview(review, product.id);                    
              resetForm();
            }}
          >
            {({ errors, touched }) => (
